                        ...
                        <div className="rounded-2xl border border-l-4 border-border border-l-primary bg-card p-5 sm:p-6">
                            <div className="flex items-start gap-3.5">
                                ...
                                <div className="min-w-0 flex-1 pt-0.5">
                                    ...
                                    <h1 className="mt-1.5 font-serif text-lg leading-snug text-foreground sm:text-xl">
                                        Sesi dengan Nadia P.
                                    </h1>
                                    <p className="mt-1 text-sm text-muted-foreground">
                                        Senin, 14 Juli 2026 &middot; 14.00–15.00
                                        WIB &middot; Online
                                    </p>
                                </div>
                            </div>
                            ...
                            {/* Referensi lain (tidak aktif bersamaan):
                            STATUS === 'pending_confirmation' → tombol
                            "Konfirmasi" (CheckCircle2) & "Tolak" (XCircle).
                            STATUS === 'in_progress' → tombol "Tandai Sesi
                            Selesai". STATUS === 'completed' → tanpa aksi. */}
                        </div>

                        {/* ---- Info Konsultasi ---- */}
                        <div className="rounded-2xl border border-border bg-card p-5">
                            <div className="grid grid-cols-2 gap-x-3 gap-y-4 text-sm sm:grid-cols-4">
                                <div className="flex items-start gap-2.5">
                                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-violet-50 text-violet-600 dark:bg-violet-950/30 dark:text-violet-400">
                                        <Users size={13} />
                                    </span>
                                    <div>
                                        <p className="text-xs text-muted-foreground">
                                ...
                                <div className="flex items-start gap-2.5">
                                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-emerald-50 text-emerald-600 dark:bg-emerald-950/30 dark:text-emerald-400">
                                        <History size={13} />
                                    </span>
                                    <div>
                                        <p className="text-xs text-muted-foreground">
                                ...
                                <div className="flex items-start gap-2.5">
                                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-teal-50 text-teal-600 dark:bg-teal-950/30 dark:text-teal-400">
                                        <Video size={13} />
                                    </span>
                                    <div>
                                        <p className="text-xs text-muted-foreground">
                                ...
                                <div className="flex items-start gap-2.5">
                                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-orange-50 text-orange-600 dark:bg-orange-950/30 dark:text-orange-400">
                                        <Clock size={13} />
                                    </span>
                                    <div>
                                        <p className="text-xs text-muted-foreground">
                            ...
                            <div className="mt-4 divide-y divide-border/70 overflow-hidden rounded-xl border border-border/70">
                                <div className="p-3.5">
                                    ...
                                    <div className="mt-2 flex flex-wrap gap-2">
                                        ...
                                        <button
                                            type="button"
                                            className="inline-flex items-center gap-1.5 rounded-full border border-border px-3.5 py-1.5 text-xs font-semibold text-muted-foreground transition hover:border-foreground/40 hover:text-foreground"
                                        >
                                            <Copy size={12} /> Salin
                                        </button>
                                    </div>
