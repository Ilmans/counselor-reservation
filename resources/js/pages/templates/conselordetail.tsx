// ─────────────────────────────────────────────
// DETAIL KONSELOR PAGE — Profile + Reviews
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <aside className="flex flex-col gap-4 lg:col-span-1">
                        ...
                        <div className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800/80 dark:bg-[#111113]">
                            ...
                            <button className="mt-2 w-full rounded-lg border border-zinc-200 py-2.5 text-[13px] font-medium text-zinc-600 transition-colors hover:border-zinc-400 hover:text-zinc-800 dark:border-zinc-700/60 dark:text-zinc-400 dark:hover:border-zinc-500 dark:hover:text-zinc-200">
                                Kirim Pesan
                            </button>
                        </div>
                        ...
                        <section>
                            ...
                            <div className="flex flex-col gap-3">
                                {[
                                    {
                                        year: '2019',
                                        title: 'Magister Psikologi Klinis',
                                    ...
                                    {
                                        year: '2020',
                                        title: 'Sertifikasi CBT — Beck Institute',
                                        institution: 'Internasional',
                                    },
                                    {
                                        year: '2021',
                                        title: 'Sertifikasi EMDR Level 1',
                                        institution: 'EMDR Indonesia',
                                    },
                                ].map((item) => (
                                    <div
                                        key={item.title}
                                    ...
                                    >
                                        <span className="mt-0.5 w-10 flex-shrink-0 text-[11px] font-medium text-zinc-400 dark:text-zinc-600">
                                            {item.year}
                                        </span>
                                        <div>
