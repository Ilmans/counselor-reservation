        ...
        <Modal open={open} onClose={onClose}>
            ...
            <div className="mt-5 flex gap-2">
                ...
                <button
                    type="button"
                    onClick={onConfirm}
                    className={`flex-1 rounded-full px-4 py-2.5 text-xs font-semibold text-white transition focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none ${
